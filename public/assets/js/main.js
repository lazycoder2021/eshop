...
document.querySelector('.form--register').addEventListener('submit', function (e) {
	...
	fetch('https://eshop.onrender.com/register', {
		...
		if (data.msg == "Verification email has been sent. Please check your inbox and verify your email to complete registration") {
			document.querySelector('.success_message1').classList.remove('hide');
			setInterval(() => {
				document.querySelector('.success_message1').classList.add('hide');
			}, 2000)
		} else if(data.msg == "some error occurred"){
			document.querySelector('.error_message1').classList.remove('hide'); 
			setInterval(() => {
				document.querySelector('.error_message1').classList.add('hide');
			}, 2000)
        }
    })
...
document.querySelector('.form--login').addEventListener('submit', function (e) {
	...
	fetch('https://eshop.onrender.com/login', {
		...
		if (data.msg == "Passcode has been sent to your mail. Please use that to login") {
			...
			setInterval(() => {
				document.querySelector('.success_message').classList.add('hide');
			}, 2000)
		} else if (data.msg == "account does not exist") {
